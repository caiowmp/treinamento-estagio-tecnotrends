...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <div class="row" style="text-align: left;">
        ...
        <table>
            <tr style="display: grid;">
                ...
                <td>
                    <asp:TextBox ID="txbCadastroNomeAutor" runat="server" CssClass="form-control" Height="35px"
                ...
                <td>
                    <asp:TextBox ID="txbCadastroSobrenomeAutor" runat="server" CssClass="form-control" Height="35px"
                        Width="400px"></asp:TextBox>
                ...
                <td>
                    <asp:TextBox ID="txbCadastroEmailAutor" runat="server" CssClass="form-control" Height="35px"
                        Width="400px"></asp:TextBox>
    ...
    <div class="row">
        ...
        <asp:GridView ID="gvGerenciamentoAutores" runat="server" Width="100%" AutoGenerateColums="False"
            Font-Size="14px" CellPadding="4" ForeColor="#333333" GridLines="None" 
            OnRowCancelingEdit="gvGerenciamentoAutores_RowUpdating" OnRowDeleting="gvGereciamentoAutores_RowDeleting"
            OnRowCommand="gvGerenciamentoAutores_RowCommand">
            <Colums>
                <asp:TemplateField Visible="False">
                    <EditItemTemplate>
                        <asp:Label ID="lblEditAutor" runat="server" Text='<% Eval("aut_id_autor") %>'></asp:Label>
                    </EditItemTemplate>
                    <HeaderTemplate>
                ...
                <asp:TemplateField>
                    <EditItemTemplate>
                        <asp:TextBox ID="txbEditNomeAutor" runat="server" CssClass="form-control" Heigh="35px"
                ...
                <asp:TemplateField>
                    <EditItemTemplate>
                        <asp:TextBox ID="txbEditSobrenomeAutor" runat="server" CssClass="form-control" Heigh="35px"
                ...
                <asp:TemplateField>
                    <EditItemTemplate>
                        <asp:TextBox ID="txbEditEmailAutor" runat="server" CssClass="form-control" Heigh="35px"
